class WebAnalyzer {
    ...
    celebrate() {
        ...
        if (window.confettiCannon) {
            window.confettiCannon.celebrate();
        }
    ...
    triggerMegaCelebration() {
        ...
        if (window.confettiCannon) {
            window.confettiCannon.launchConfetti('mega');

            for (let i = 0; i < 5; i++) {
                setTimeout(() => {
                    window.confettiCannon.launchFireworks(2);
                }, i * 600);
            }
            ...
            for (let i = 0; i < 8; i++) {
                setTimeout(() => {
                    ...
                    window.confettiCannon.launchGlitterBurst(x, y);
                }, i * 400);
            }
        }
