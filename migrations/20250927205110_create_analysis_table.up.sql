...
COMMENT ON COLUMN analysis.duration IS 'Total processing duration in milliseconds from request creation to completion (auto-calculated by outbox_events trigger)';
