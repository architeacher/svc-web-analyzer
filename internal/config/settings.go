...
type (
	...
	HTTPServerConfig struct {
		...
		ShutdownTimeout time.Duration `envconfig:"HTTP_SERVER_SHUTDOWN_TIMEOUT" default:"10s" json:"shutdown_timeout"`
	}
	...
	WebFetcherConfig struct {
		...
		UserAgent            string               `envconfig:"WEB_FETCHER_USER_AGENT" default:"WebPageAnalyzer/1.0" json:"user_agent"`
